...
DROP DATABASE IF EXISTS easy_parking;
CREATE DATABASE easy_parking CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE easy_parking;
...
CREATE TABLE tarifas (
    ...
    valor_hora_adicional DECIMAL(10,2) DEFAULT 0.00, -- Para modo hora+adicional
    activa BOOLEAN DEFAULT TRUE,
    -- Configuración de cobro
    modo_cobro ENUM('minuto','hora','dia','mixto','hora_adicional') NOT NULL DEFAULT 'mixto',
...
CREATE TABLE pagos (
    ...
    CONSTRAINT chk_metodo_pago CHECK (metodo_pago IN ('efectivo', 'tarjeta', 'Nequi')),
...
VALUES ('Parqueadero Central', '123456789-2', 'Calle Principal #123', '3158357923', 'easy_parking@gmail.com', 'premium');
