...
(function(){
	...
	function shouldShow(){
		try{
			...
			var t = todayKey();
			// Deshabilitado para no mostrar el banner de pie de página.
			return false;
		...
		'<div class="container-fluid px-3 text-center">',
			'<div class="mx-auto" style="max-width: 980px">',
				'<p class="mb-2 small lh-base">',
					...
					'<a class="'+linkClass+'" href="https://lenixpantoja.com/" target="_blank" rel="noopener">Ciscode</a>. ',
				...
				'<div class="d-grid gap-2 d-sm-flex justify-content-center flex-wrap">',
					'<a class="btn btn-sm '+outlineBtn+'" href="https://lenixpantoja.com/" target="_blank" rel="noopener" aria-label="Sitio del desarrollador">',
